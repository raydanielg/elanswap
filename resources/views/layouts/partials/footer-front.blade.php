<footer class="border-t border-primary-800 bg-primary-900/95 text-blue-100">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="md:col-span-2">
        <a href="{{ route('home.public') }}" class="flex items-center gap-2">
          ...
          <span class="text-xl font-bold tracking-tight text-white">ElanSwap</span>
        </a>
        <p class="mt-3 text-sm leading-relaxed text-blue-200/90">
          ElanSwap ni mfumo wa kidijitali unaorahisisha kubadilishana vituo vya kazi. Tengeneza maombi,
          tafuta mechi zinazofaa, na hama kwa urahisi — kwa weledi na kasi.
        </p>

        <!-- Socials -->
        <div class="mt-4 flex items-center gap-3">
          <a href="#" class="p-2 rounded-md ring-1 ring-white/10 hover:bg-white/10" aria-label="Facebook">
          ...
          <a href="#" class="p-2 rounded-md ring-1 ring-white/10 hover:bg-white/10" aria-label="Twitter">
          ...
          <a href="#" class="p-2 rounded-md ring-1 ring-white/10 hover:bg-white/10" aria-label="Instagram">
          ...
          <a href="#" class="p-2 rounded-md ring-1 ring-white/10 hover:bg-white/10" aria-label="LinkedIn">
      ...
      <!-- Quick Links -->
      <div>
        <div class="text-sm font-semibold text-white tracking-wide uppercase">Quick Links</div>
        <ul class="mt-3 space-y-2 text-sm">
          <li><a href="{{ route('dashboard') }}" class="hover:underline hover:text-white/90">Dashboard</a></li>
          <li><a href="{{ route('destinations.index') }}" class="hover:underline hover:text-white/90">Destinations</a></li>
          <li><a href="{{ route('applications.index') }}" class="hover:underline hover:text-white/90">My Applications</a></li>
          <li><a href="{{ route('requests.index') }}" class="hover:underline hover:text-white/90" data-requires-payment>My Requests</a></li>
          <li><a href="{{ route('blog.index') }}" class="hover:underline hover:text-white/90">Blog</a></li>
        </ul>
      </div>

      <!-- Contact -->
      <div>
        <div class="text-sm font-semibold text-white tracking-wide uppercase">Contact</div>
        <ul class="mt-3 space-y-2 text-sm">
    ...
    <div class="mt-10 pt-6 border-t border-primary-800 flex flex-col sm:flex-row items-center justify-between gap-3">
      <p class="text-xs text-blue-200">© {{ date('Y') }} ElanSwap. All rights reserved.</p>
      <p class="text-xs text-blue-200">
        Developed with <span class="text-rose-400">♥</span> by <span class="font-semibold text-white">ElanTechnologies</span>
      </p>
    </div>
  </div>
</footer>
