...
@elseif($name === 'search' || $name === 'magnify')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}">
...
@elseif($name === 'bell' || $name === 'notifications')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}">
...
@elseif($name === 'lifebuoy' || $name === 'support')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}">
...
@elseif($name === 'lock' || $name === 'lock-closed')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}">
...
@elseif($name === 'verified' || $name === 'shield-check')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $class }}" width="{{ $size }}" height="{{ $size }}">
