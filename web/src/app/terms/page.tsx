    ...
    <section className="page-dark-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <header className="mb-8">
          ...
          <p className="mt-2 text-white/80 max-w-2xl">Please read these terms carefully before using Elan Swap.</p>
        </header>
        ...
        <nav aria-label="Table of contents" className="mb-8 rounded-xl border border-white/15 bg-white/5 p-4">
          ...
          <ol className="list-decimal pl-5 space-y-1 text-white/85 text-sm">
            ...
            <li><a className="hover:text-white" href="#use">Use of the Service</a></li>
            <li><a className="hover:text-white" href="#accounts">Accounts & Security</a></li>
            <li><a className="hover:text-white" href="#content">Content</a></li>
            <li><a className="hover:text-white" href="#payments">Payments</a></li>
            <li><a className="hover:text-white" href="#disclaimer">Disclaimer</a></li>
            <li><a className="hover:text-white" href="#liability">Limitation of Liability</a></li>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <figure className="my-6 rounded-xl overflow-hidden border border-white/15 bg-white/5">
            <img src="/black-female-teacher-stands-front-explains-lesson-by-reading-from-book-from-desk_404612-572.jpg" alt="Agreement" className="w-full h-56 object-cover" />
