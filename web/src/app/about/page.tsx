    ...
    <section className="page-dark-bg">
      ...
      <div className="relative overflow-hidden border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-white">About Elan Swap</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="mt-8 rounded-lg border border-yellow-400/30 bg-yellow-500/10 p-3 text-yellow-200 text-xs">
          <strong className="mr-2 text-yellow-300">DISCLAIMER:</strong>
