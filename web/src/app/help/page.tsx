    ...
    <section className="page-dark-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <figure className="mb-8 rounded-2xl overflow-hidden border border-white/15 bg-white/5">
          <img src="/african-woman-teaching-children-class_23-2148892563 (1).jpg" alt="Community support" className="w-full h-52 object-cover" />
        </figure>
        ...
        <div className="mb-8 flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 p-3">
          ...
          <input aria-label="Search help" placeholder="Tafuta swali au mada..." className="bg-transparent outline-none text-sm text-white/90 w-full placeholder:text-white/50" />
          <span className="text-[10px] text-white/60 border border-white/20 rounded px-1.5 py-0.5">Coming soon</span>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <aside>
            <div className="rounded-2xl border border-white/15 bg-white/5 p-6">
              <h2 className="text-white font-semibold text-lg">Still need help?</h2>
              ...
              <a href="#contact" className="mt-4 inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] shadow hover:brightness-105">Contact form</a>
            </div>

            <figure className="mt-6 rounded-2xl overflow-hidden border border-white/15 bg-white/5">
              <img src="/black-cheerful-woman-smiling-sitting-table-stock-photo_195114-64871.jpg" alt="Support" className="w-full h-40 object-cover" />
